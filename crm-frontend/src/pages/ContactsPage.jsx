        ...
        <div className="animate-fade-in max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10">
                <div>
                    ...
                    <p className="text-slate-400 text-base mt-2 font-medium">{contacts.length} total contacts</p>
                </div>
                    ...
                    {contacts.map((c, i) => (
                        ...
                        >
                            ...
                            <div className="space-y-2 text-sm text-slate-400">
                                ...
                                {c.company && (
                                    <div className="pt-1">
                                        <span className="badge badge-qualification shadow-sm text-[0.7rem]">{c.company}</span>
                                    </div>
                                )}
                            </div>
                            {c.notes && (
                                <p className="mt-4 text-xs text-slate-500 line-clamp-2 border-t border-white/5 pt-3 leading-relaxed">
                                    {c.notes}
                                </p>
                            )}
                        </div>
